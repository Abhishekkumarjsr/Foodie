...
<body>
    ...
    <section class="dishes" id="dishes">
        <h3 class="dishes-page-sub-heading"> Sandwiches </h3>
        <h1 class="heading">Our Popular Sandwiches</h1>
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="#" class="fas fa-eye"></a>
                    <h3>Sandwich</h3>
                    <p>Philly Cheesesteak Sandwich</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="#" class="fas fa-eye"></a>
                    <h3>Sandwich</h3>
                    <p>Italian Submarine Sandwich</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="#" class="fas fa-eye"></a>
                    <h3>Sandwich</h3>
                    <p>Grilled Chicken Pesto Sandwich</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <a href="#" class="fas fa-eye"></a>
                    <h3>Sandwich</h3>
                    <p>Portobello Mushroom Panini Sandwich</p>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
